...
<p>Infections caused by CRE have limited treatment options and have been associated with high mortality rates, according to a report by Neil Gupta, MD,'.footnote(1,$footnotes).'and his team at the Centers for Disease Control and Prevention.</p>
...
<p>But if the plasmid that makes bacteria resistant to colistin were to spread to a CRE strain of bacteria (that was already resistant to carbapenem), doctors would not be able to use either powerful antibiotic to treat the infection.'.footnote(2,$footnotes).'</p>
